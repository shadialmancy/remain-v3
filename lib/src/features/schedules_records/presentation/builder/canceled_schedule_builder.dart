...
class CanceledScheduleBuilder extends StatelessWidget {
  const CanceledScheduleBuilder({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    return data?.isEmpty ?? true
        ? Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
            gapH48,
            ScheduleEmpty(title: l10n.thereAreNoCanceledAppointments),
          ])
