...
mixin _$OffersEntity {
  ...
  /// Serializes this OffersEntity to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of OffersEntity
...
class _$OffersEntityImpl implements _OffersEntity {
  ...
  @override
  String toString() {
    return 'OffersEntity(requestId: $requestId, code: $code, errorMessage: $errorMessage, totalpage: $totalpage, data: $data)';
  }
...
abstract class _OffersEntity implements OffersEntity {
  factory _OffersEntity(
      {@JsonKey(name: 'request_id') final String? requestId,
      final num? code,
      @JsonKey(name: 'error_message') final String? errorMessage,
      final num? totalpage,
      final List<OfferData>? data}) = _$OffersEntityImpl;
