...
abstract class $DataCopyWith<$Res> {
  ...
  @useResult
  $Res call({Info? info, List<Availability>? availabilities});
...
class _$DataImpl implements _Data {
  _$DataImpl({this.info, final List<Availability>? availabilities})
  ...
  @override
  String toString() {
    return 'Data(info: $info, availabilities: $availabilities)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, info, const DeepCollectionEquality().hash(_availabilities));
...
abstract class _Data implements Data {
  factory _Data({final Info? info, final List<Availability>? availabilities}) =
      _$DataImpl;
